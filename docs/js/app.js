...
/*
    let ws = duct.createDataChannel("lidar-center",{ordered:false,maxRetransmits:5});
    ...
    ws = duct.createDataChannel("lidar-left",{ordered:false,maxRetransmits:1});
    ...
    ws = duct.createDataChannel("lidar-right",{ordered:false,maxRetransmits:1});
